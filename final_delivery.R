...
market_data<-read.csv("C:/Users/조/Desktop/공모전/seoul_traditional_market.csv")
View(market_data)
...
station_data<-read_excel("C:/Users/조/Desktop/공모전/seoul_subway_address.xlsx")
...
###########
metro<-read_excel("C:/Users/조/Desktop/공모전/sangdo_station_floating.xlsx")
View(metro)
...
library(readxl)
library(dplyr)
sangdo <- read_excel("C:/Users/조/Desktop/공모전/sangdo_station_floating.xlsx")
...
#############
metro<- read.csv("C:/Users/조/Desktop/공모전/seoul_subway_station_population.csv")
library(dplyr)
View(metro)
...
install.packages("readxl")
library(readxl)
deliver<-read_excel("C:/Users/조/Desktop/공모전/total_delivery_app_using.xlsx")
View(deliver)
str(deliver)
install.packages("ggplot2")
library(ggplot2)
...
#################
library(readxl)
floation<-read_excel("C:/Users/조/Desktop/공모전/floating_population.xlsx")
View(floation)
...
############
floation<-read_excel("C:/Users/조/Desktop/공모전/floating_subway_correlation.xlsx")
View(floation)
...
############
library(readxl)
demand<-read_excel("C:/Users/조/Desktop/공모전/subway_station_supply_demand.xlsx")
View(demand)
